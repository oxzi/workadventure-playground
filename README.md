...
- the main rooms of the Hackspace Marburg,
- a comfy bonfire place, and
- a landing map to dispatch to the other maps.


## Tiles

- `custom-tiles.png`: Created for this repository; RC3-like logos were generated by the [logogenerator][].
